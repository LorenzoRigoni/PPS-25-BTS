...
trait MultipleAnswersMiniGameLogic:
   ...
   * @return  a new instance of the game logic and the question generated
   */
  def generateQuestion: (MultipleAnswersMiniGameLogic, String)
  /**
   * Method that calculates the percentage of correctness of the answer, instead of a simple true/false result
   * @param question generated from the game logic
   * @param answer the user input
   * @return  a score from 0.0 (completely wrong) to 1.0 (completely correct)
   */
